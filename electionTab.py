...
trendType
    ...
    if(len(columnsValueDict)>0):
        ...
        print()
    if(len(midElectionYearReturns)>0):
        midElectionYearReturns = midElectionYearReturns.set_index('Mid Election Year')
    midElectionDatatableToDownload = dcc.send_data_frame(midElectionYearReturns.to_csv, 'youngTurtle_midElectionReturns.csv')
